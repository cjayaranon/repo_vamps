...
urlpatterns = [
    ...
    url(r'^home/cashier/maf-release-search/maf-release-view/(?P<id>\w+)/$', views.ReleaseMAFtable.as_view(), name="release_maf_table"),
    url(r'^home/cashier/maf-release-search/maf-release-view/maf-release-form/(?P<id>\w+)/$', views.ReleaseMAF.as_view(), name="release_maf_form"),
    ...
    url(r'^home/cashier/release-odf-search/release-odf-view/(?P<id>\w+)/$', views.ReleaseODFView.as_view(), name="release_odf_view"),
    url(r'^home/cashier/release-odf-search/release-odf-view/release-odf/(?P<id>\w+)/$', views.ReleaseODFForm.as_view(), name="release_odf_form"),
